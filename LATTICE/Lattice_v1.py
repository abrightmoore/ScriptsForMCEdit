		...
		for iterX in xrange(1, width-1):
			for iterZ in xrange(1, depth-1):
				...
				if temp != 0: # Found a block - check if it is a surface. Note all non-air is considered a block for surface checking.
					if schematic.blockAt(iterX-1, iterY, iterZ) == 0 or schematic.blockAt(iterX+1, iterY, iterZ) == 0 or schematic.blockAt(iterX, iterY-1, iterZ) == 0 or schematic.blockAt(iterX, iterY+1, iterZ) == 0 or schematic.blockAt(iterX, iterY, iterZ-1) == 0 or schematic.blockAt(iterX, iterY, iterZ+1) == 0:
