...
GEOMETRY = [ #128
					["HEAD_TOP",16,0,"H",8,63,0,16,16,-1,-1],
					["HEAD_BOTTOM",32,0,"H",8,48,0,16,16,-1,-1],
					["HEAD_RIGHT",32,16,"VZ",8,48,0,16,16,1,-1],
					["HEAD_FRONT",16,16,"VX",8,48,0,16,16,-1,-1],
					["HEAD_LEFT",0,16,"VZ",23,48,0,16,16,-1,-1],
					["HEAD_BACK",48,16,"VX",8,48,15,16,16,1,-1],

					["HELMET_OUTER_TOP",80,0,"H",8,63,0,16,16,-1,-1],
					["HELMET_OUTER_BOTTOM",96,0,"H",8,48,0,16,16,-1,-1],					
					["HELMET_OUTER_RIGHT",96,16,"VZ",8,48,0,16,16,1,-1],
					["HELMET_OUTER_FRONT",80,16,"VX",8,48,0,16,16,-1,-1],
					["HELMET_OUTER_LEFT",64,16,"VZ",23,48,0,16,16,-1,-1],
					["HELMET_OUTER_BACK",112,16,"VX",8,48,15,16,16,1,-1],

					["LEG_RIGHT_TOP",40,96,"H",8,23,4,8,8,-1,-1],
					["LEG_RIGHT_BOTTOM",48,96,"H",8,0,4,8,8,-1,-1],
					["LEG_RIGHT_RIGHT",48,104,"VZ",8,0,4,8,24,1,-1],
					["LEG_RIGHT_FRONT",40,104,"VX",8,0,4,8,24,-1,-1],
					["LEG_RIGHT_LEFT",32,104,"VZ",16,0,4,8,24,-1,-1],
					["LEG_RIGHT_BACK",56,104,"VX",8,0,11,8,24,1,-1],
					
					["LEG_RIGHT_OUTER_TOP",8,96,"H",8,23,4,8,8,-1,-1],
					["LEG_RIGHT_OUTER_BOTTOM",16,96,"H",8,0,4,8,8,-1,-1],
					["LEG_RIGHT_OUTER_RIGHT",16,104,"VZ",8,0,4,8,24,1,-1],
					["LEG_RIGHT_OUTER_FRONT",8,104,"VX",8,0,4,8,24,-1,-1],
					["LEG_RIGHT_OUTER_LEFT",0,104,"VZ",16,0,4,8,24,-1,-1],
					["LEG_RIGHT_OUTER_BACK",24,104,"VX",8,0,11,8,24,1,-1],

					["LEG_LEFT_TOP",8,32,"H",16,23,4,8,8,-1,-1],
					["LEG_LEFT_BOTTOM",16,32,"H",16,0,4,8,8,-1,-1],
					["LEG_LEFT_RIGHT",16,40,"VZ",15,0,4,8,24,1,-1],
					["LEG_LEFT_FRONT",8,40,"VX",16,0,4,8,24,-1,-1],
					["LEG_LEFT_LEFT",0,40,"VZ",23,0,4,8,24,-1,-1],
					["LEG_LEFT_BACK",24,40,"VX",16,0,11,8,24,1,-1],
					
					["LEG_LEFT_OUTER_TOP",8,64,"H",16,23,4,8,8,-1,-1],
					["LEG_LEFT_OUTER_BOTTOM",16,64,"H",16,0,4,8,8,-1,-1],
					["LEG_LEFT_OUTER_RIGHT",16,72,"VZ",15,0,4,8,24,1,-1],
					["LEG_LEFT_OUTER_FRONT",8,72,"VX",16,0,4,8,24,-1,-1],
					["LEG_LEFT_OUTER_LEFT",0,72,"VZ",23,0,4,8,24,-1,-1],
					["LEG_LEFT_OUTER_BACK",24,72,"VX",16,0,11,8,24,1,-1],
					
					["TORSO_TOP",40,32,"H",8,47,4,16,8,-1,-1],
					["TORSO_BOTTOM",56,32,"H",8,24,4,16,8,-1,-1],
					["TORSO_RIGHT",56,40,"VZ",8,24,4,8,24,1,-1],
					["TORSO_FRONT",40,40,"VX",8,24,4,16,24,-1,-1],
					["TORSO_LEFT",32,40,"VZ",23,24,4,8,24,-1,-1],
					["TORSO_BACK",64,40,"VX",8,24,11,16,24,1,-1],

					["TORSO_OUTER_TOP",40,64,"H",8,47,4,16,8,-1,-1],
					["TORSO_OUTER_BOTTOM",56,64,"H",8,24,4,16,8,-1,-1],
					["TORSO_OUTER_RIGHT",56,72,"VZ",8,24,4,8,24,1,-1],
					["TORSO_OUTER_FRONT",40,72,"VX",8,24,4,16,24,-1,-1],
					["TORSO_OUTER_LEFT",32,72,"VZ",23,24,4,8,24,-1,-1],
					["TORSO_OUTER_BACK",64,72,"VX",8,24,11,16,24,1,-1],
					
					["ARM_RIGHT_TOP",72,96,"H",0,47,4,8,8,-1,-1],
					["ARM_RIGHT_BOTTOM",80,96,"H",0,24,4,8,8,-1,-1],
					["ARM_RIGHT_RIGHT",80,104,"VZ",0,24,4,8,24,1,-1],
					["ARM_RIGHT_FRONT",72,104,"VX",0,24,4,8,24,-1,-1],
					["ARM_RIGHT_LEFT",64,104,"VZ",7,24,4,8,24,-1,-1],
					["ARM_RIGHT_BACK",88,104,"VX",0,24,11,8,24,1,-1],

					["ARM_RIGHT_OUTER_TOP",104,96,"H",0,47,4,8,8,-1,-1],
					["ARM_RIGHT_OUTER_BOTTOM",112,96,"H",0,24,4,8,8,-1,-1],
					["ARM_RIGHT_OUTER_RIGHT",112,104,"VZ",0,24,4,8,24,1,-1],
					["ARM_RIGHT_OUTER_FRONT",104,104,"VX",0,24,4,8,24,-1,-1],
					["ARM_RIGHT_OUTER_LEFT",96,104,"VZ",7,24,4,8,24,-1,-1],
					["ARM_RIGHT_OUTER_BACK",120,104,"VX",0,24,11,8,24,1,-1],
					
					["ARM_LEFT_TOP",88,32,"H",24,47,4,8,8,-1,-1],
					["ARM_LEFT_BOTTOM",96,32,"H",24,24,4,8,8,-1,-1],
					["ARM_LEFT_RIGHT",96,40,"VZ",24,24,4,8,24,1,-1],
					["ARM_LEFT_FRONT",88,40,"VX",24,24,4,8,24,-1,-1],
					["ARM_LEFT_LEFT",80,40,"VZ",31,24,4,8,24,-1,-1],
					["ARM_LEFT_BACK",104,40,"VX",24,24,11,8,24,1,-1],
					
					["ARM_LEFT_OUTER_TOP",88,64,"H",24,47,4,8,8,-1,-1],
					["ARM_LEFT_OUTER_BOTTOM",96,64,"H",24,24,4,8,8,-1,-1],
					["ARM_LEFT_OUTER_RIGHT",96,72,"VZ",24,24,4,8,24,1,-1],
					["ARM_LEFT_OUTER_FRONT",88,72,"VX",24,24,4,8,24,-1,-1],
					["ARM_LEFT_OUTER_LEFT",80,72,"VZ",31,24,4,8,24,-1,-1],
					["ARM_LEFT_OUTER_BACK",104,72,"VX",24,24,11,8,24,1,-1],
			]
...
def skinnyImageto3D(level,box,options):
	...
	for (key,pngx,pngy,dir,x,y,z,dim1,dim2,delta1,delta2) in GEOMETRY:
		if (options["Outer?"] == False and "OUTER" not in key) or (options["Outer?"] == True and "OUTER" in key):
			print "Processing",(key,pngx,pngy,dir,x,y,z,dim1,dim2,delta1,delta2)
...
def skinny3DtoImage(level,box,options):
	...
	try:
		...
		img = pygame.Surface((128,128),SRCALPHA) # ToDo: SD/HD
