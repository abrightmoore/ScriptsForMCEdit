...
inputs = (
	  ("CARVER", "label"),
	  ("Shape", ("Sphere","Sphere-","Cylinder (Vertical)","Cylinder- (Vertical)","Boulder","Diagonal Vertical++","Diagonal Vertical+-","Diagonal Vertical--","Diagonal Vertical-+","Diagonal Width++","Diagonal Width+-","Diagonal Width--","Diagonal Width-+","Diagonal Depth++","Diagonal Depth+-","Diagonal Depth--","Diagonal Depth-+")), #
...
def Carver(level, box, options):
	...
	elif POSTSHAPE == "Diagonal Vertical++":
