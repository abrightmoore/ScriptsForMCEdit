...
def Ent(level, box, options):
	...
	for y in xrange(0, height):
		...
		for r in xrange(1,radius):
			...
			x1 = r * cos((Orientation+90)*angle)
			z1 = r * sin((Orientation+90)*angle)
			drawLine(level, MATERIAL, (box.minx+centreWidth+x,box.miny+y,box.minz+centreDepth+z), (box.minx+centreWidth+x1,box.miny+y,box.minz+centreDepth+z1) )

			x = x1
			z = z1
			x1 = r * cos((Orientation+180)*angle)
			z1 = r * sin((Orientation+180)*angle)
			drawLine(level, MATERIAL, (box.minx+centreWidth+x,box.miny+y,box.minz+centreDepth+z), (box.minx+centreWidth+x1,box.miny+y,box.minz+centreDepth+z1) )

			x = x1
			z = z1
			x1 = r * cos((Orientation+270)*angle)
			z1 = r * sin((Orientation+270)*angle)
			drawLine(level, MATERIAL, (box.minx+centreWidth+x,box.miny+y,box.minz+centreDepth+z), (box.minx+centreWidth+x1,box.miny+y,box.minz+centreDepth+z1) )
			...
			x = x1
			z = z1
			x1 = r * cos((Orientation)*angle)
			z1 = r * sin((Orientation)*angle)
			drawLine(level, MATERIAL, (box.minx+centreWidth+x,box.miny+y,box.minz+centreDepth+z), (box.minx+centreWidth+x1,box.miny+y,box.minz+centreDepth+z1) )
