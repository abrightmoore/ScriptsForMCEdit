			...
			for iterX in xrange(0, width):
				for iterZ in xrange(0, depth):
					...
					if tempBlock != 0 and not (tempBlock in ignoreList):
						setBlock(level, (MATERIALID, coloursList[colourCounter]), box.minx + iterX, box.miny + iterY, box.minz + iterZ)
			...
			for iterY in xrange(0, height):
				for iterZ in xrange(0, depth):
					...
					if tempBlock != 0 and not (tempBlock in ignoreList):
						...
						setBlock(level, (MATERIALID, coloursList[r%len(colours)]), box.minx + iterX, box.miny + iterY, box.minz + iterZ)
